  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<CRUDService>(
        builder: (cs) {
          return cs.isLoading || uploadingShopImage
              ? Container(
                  color: Colors.white,
                  child: const Center(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () async {
                                  storePhoto = await storageService
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (businessNameController.text.isNotEmpty &&
                              ...
                              try {
                                if (storePhoto != null) {
                                  srorePhotoImageUrl = await storageService
                                      .uploadImageAndGetURL(storePhoto!);
                                }
                              } catch (e) {
                                Get.snackbar(
                                  "Error",
                              ...
                              Business business = Business(
                                  ...
                                  people: [
                                    Person(
                                        user: authService.user!, role: "Owner")
                                  ]);
